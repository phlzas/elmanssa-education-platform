...
const Header: React.FC<HeaderProps> = ({ onNavigate, currentPage }) => {
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (dropdown && !dropdown.contains(target) && avatarBtn && !avatarBtn.contains(target)) {
                  ...
                  >
                    ...
                    <div className="py-2 px-2">
                      <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-[#034289] hover:bg-[#D2E1D9]/30 transition-all duration-200 group"
                      >
