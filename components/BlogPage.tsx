            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {[
                        ...
                        <div key={idx} className="bg-white rounded-2xl shadow-sm border border-[#D2E1D9] hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1 overflow-hidden group">
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <button className="text-[#034289] font-bold text-sm hover:underline hover:text-[#4F8751] cursor-pointer transition-colors duration-200">اقرأ المزيد &larr;</button>
                                </div>
                            </div>
                        </div>
                    ))}
